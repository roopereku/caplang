...
public:
	...
	Reference findDefinition(std::string_view name, std::shared_ptr <Node> exclusion = nullptr);
	Reference findDefinitionHere(std::string_view name, std::shared_ptr <Node> exclusion = nullptr);
